...
import otus.java.servlets.service.DbServiceImpl;
...
import static otus.java.servlets.server.util.WebServerHelper.*;

class UsersWebServerWithFilterBasedSecurityTest {
    ...
    private static final String DEFAULT_USER_LOGIN = "test";
    ...
    static void setUp() throws Exception {
        ...
        DbService<User, Long> userService = mock(DbServiceImpl.class);
        ...
        given(userService.getById(DEFAULT_USER_ID)).willReturn(Optional.of(DEFAULT_USER));
    ...
    void shouldReturnCorrectUserWhenAuthorized() throws Exception {
        ...
        assertThat(response.body()).isEqualTo(gson.toJson(UserDto.toDto(DEFAULT_USER)));
    }
